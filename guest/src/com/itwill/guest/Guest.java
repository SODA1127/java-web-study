...
public class Guest {
	/*
	 * Name Null? Type -------------------------------------- --------
	 * -------------- GUEST_NO NOT NULL NUMBER(10) GUEST_NAME NOT NULL VARCHAR2(10)
	 * GUEST_DATE NOT NULL DATE GUEST_EMAIL VARCHAR2(50) GUEST_HOMEPAGE VARCHAR2(50)
	 * GUEST_TITLE NOT NULL VARCHAR2(100) GUEST_CONTENT NOT NULL VARCHAR2(4000)
	 */
