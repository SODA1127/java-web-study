...
<html>
<head>
<title><fmt:message key="page.modify.header" /></title>
...
<c:if test="${userId.equals(sUserId)}">
		<script>
			alert('${USERMSG}');
					...
					<tr>
						<td>
							...
							<table style="padding-left: 10px" border=0 cellpadding=0
								cellspacing=0>
								<tr>
									<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b><fmt:message key="page.modify.header" /></b></td>
								</tr>
							</table> <!-- update Form  -->
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											...
											name="password" value="${findUser.password}"></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22"><fmt:message key="user.repassword" /></td>
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											align="left"><input type="password" style="width: 150px"
							...
							<table width=590 border=0 cellpadding=0 cellspacing=0>
								...
								<fmt:message key="button.list" var="list"/>
									...
									<td align=center><input type="button" value="${modify}"
										onClick="userModify()"> &nbsp; <input type="button"
										value="${list}" onClick="userList()"></td>
								</tr>
							</table>
