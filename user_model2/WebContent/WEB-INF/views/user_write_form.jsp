...
<html>
<head>
<title><fmt:message key="page.write.header" /></title>
					...
					<tr>
						<td>
							...
							<table style="padding-left: 10px" border=0 cellpadding=0
								cellspacing=0>
								<tr>
									<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b><fmt:message key="page.write.header" /></b></td>
								</tr>
							</table> <!-- write Form  -->
							...
							<fmt:message key="button.create" var="create" />
								<tr>
									<td align=center><input type="button" value="${create}" onClick="userCreate()">
									&nbsp;
