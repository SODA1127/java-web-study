								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td align="left" width=490 bgcolor="ffffff"
											...
											style="width: 150" name="guest_name" value="<%=guest.getGuest_name()%>"></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">홈페이지</td>
										<td align="left" width=490 bgcolor="ffffff"
											style="padding-left: 10px"><input type="text"
											style="width: 150" name="guest_homepage" value="<%=guest.getGuest_homepage()%>"></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">이메일</td>
										<td align="left" width=490 bgcolor="ffffff"
											style="padding-left: 10px"><input type="text"
											style="width: 240" name="guest_email" value="<%=guest.getGuest_email()%>"></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">제목</td>
										<td align="left" width=490 bgcolor="ffffff"
											style="padding-left: 10px"><input type="text"
											style="width: 240" name="guest_title" value="<%=guest.getGuest_title()%>"></td>
									</tr>
									<tr>
